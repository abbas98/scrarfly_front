    ...
    return (
        ...
        <div id="loginForm" className=" flex flex-col no-wrap justify-center items-center basis-1/2 w-full p-2  bg-white rounded-2xl">
            <div className="flex flex-col w-full gap-1">
                ...
                <input placeholder="شماره موبایل" ref={phonenumber} id="login_user_name" type="tel" className="bg-gray-100 h-[60px] rounded-2xl w-full outline-none p-3 text-center mb-1" />
            </div>
